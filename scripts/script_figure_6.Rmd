...
This script will reproduce Figure 6 from *Owen et al. - Sample size planning for insect critical thermal limits studies*. 
...
```{r save_figure}
# Save figure to file 
ggplot2::ggsave(here::here("./figures/figure6.png"), 
                width = 6, 
                height = 6)
```
